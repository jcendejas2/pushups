...
We used a t.test plot because we only have 2 categorical levels of position which are "line" and "skill".  

When running an inferential test, the result produces a P-value of 0.000009421 which is less than 0.05 which leads us to reject the null hypothesis that there is no difference in the average number of pushups players can do in two minutes based on the position they play.
